...
~> **Important:** The source VM must be powered off before cloning. VirtualBox locks the disk when a VM is running, which prevents the clone operation from accessing the source disk.
